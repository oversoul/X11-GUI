...
#   XCB_XRM_FOUND    XCB_XRM_INCLUDE_DIR    XCB_XRM_LIBRARY
#
...
foreach(comp ${comps})
    ...
    if("${index}" STREQUAL "-1")
        ...
        elseif("${comp}" STREQUAL "XRM")
            list(APPEND pkgConfigModules "xcb-xrm")
...
macro(_XCB_HANDLE_COMPONENT _comp)
    ...
    elseif("${_comp}" STREQUAL "XINPUT")
        ...
        set(_lib "xcb-xinput")
    elseif("${_comp}" STREQUAL "XRM")
        set(_header "xcb/xcb_xrm.h")
        set(_lib "xcb-xrm")
